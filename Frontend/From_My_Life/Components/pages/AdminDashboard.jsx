                ...
                >
                    ...
                    {gridYs.map((g, i) => (
                        <g key={i}>
                            ...
                            <text x={PAD.left - 6} y={g.y + 4}
                                textAnchor="end" fontSize="10" fill="var(--text-main)" opacity="0.6">{g.val}</text>
                        </g>
                    ))}
                    ...
                    {monthBuckets.map((b, i) => (
                        <text key={i} x={xPos(i)} y={H - 6}
                            textAnchor="middle" fontSize="11" fill="var(--text-main)" fontWeight="600" opacity="0.7">
                            {b.label}
                        </text>
                    ))}
                    ...
                    {tooltip && (
                        <line
                            ...
                            stroke="rgba(0,0,0,0.1)" strokeWidth="1" strokeDasharray="4 3"
                        />
                    )}
